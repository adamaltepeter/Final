...
combined<-data.frame(ann=as.numeric(as.character(ann_predicted_01)),knn=as.numeric(as.character(knn_predict_01)),log=as.numeric(as.character(lr_predict)),dt=as.numeric(as.character(tree_predict)), svm=as.numeric(as.character(SVM_predictions_rbf)), actual=hr_mm$AttritionYes)
combined

# Selects 2000 random rows for test data
set.seed(12345)
combinedtest_set <- sample(1:nrow(combined), 2000) 
